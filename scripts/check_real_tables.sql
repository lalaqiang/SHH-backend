-- ============================================================================
-- DeepHuaHui ERP - DB table check (NO Chinese in PRINT to avoid encoding issues)
-- Run: sqlcmd -S localhost -d TestERP -U sa -P sa123456 -C -i check_real_tables.sql -o out.txt
-- ============================================================================
SET NOCOUNT ON
GO
...
WHERE xtype = 'U' AND (
    ...
    OR name LIKE 'tWorkFlow%' OR name LIKE 'tFlow_%'
)
ORDER BY name
GO
...
PRINT ''
PRINT '====== 8. Business PK survey (t% tables) ======'
GO
SELECT
    c.TABLE_NAME,
